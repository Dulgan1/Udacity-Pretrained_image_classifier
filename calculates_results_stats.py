...
#                                                                             
# PROGRAMMER: DULGAN DANJUMA
# DATE CREATED: 10TH JULY 2023
# REVISED DATE: 11TH JULY 2023
...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        n_correct_dogs += (results_dic[key][3] and results_dic[key][4])
        n_correct_breed += (results_dic[key][2] and results_dic[key][3])
        n_correct_notdogs += (results_dic[key][3]==0 and results_dic[key][4]==0)
